...
import { CREATURE_TYPES, type CreatureTypeDef } from "@primal-grid/shared";
...
describe("Phase 2.4 — Creature Type Definitions", () => {
  ...
  it("has at least one herbivore definition", () => {
    ...
    const types = Object.values(CREATURE_TYPES) as (CreatureTypeDef & { diet?: string })[];
  ...
  it("all creature types have a name string", () => {
    for (const creature of Object.values(CREATURE_TYPES)) {
