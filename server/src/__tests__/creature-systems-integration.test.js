...
import { CREATURE_TYPES, CREATURE_RESPAWN, } from "@primal-grid/shared";
// ── Helpers ─────────────────────────────────────────────────────────
...
describe("Creature Systems Integration", () => {
    ...
    it("creatures maintain population through respawning", () => {
        ...
        const minPop = CREATURE_TYPES["herbivore"].minPopulation;
        const toRemove = [];
        let herbCount = 0;
        room.state.creatures.forEach((c) => {
            if (c.creatureType === "herbivore")
...
//# sourceMappingURL=creature-systems-integration.test.js.map